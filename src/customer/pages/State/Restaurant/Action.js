...
//It takes an object as its argument with properties restaurantId, restaurantData, and jwt. 
//These properties are the ID and data of restaurant to be updated, and JWT for authentication.
...
export const updateRestaurantStatus = ({ restaurantId, jwt }) => {
  return async (dispatch) => {
    ...
    try {
    //empty body {} because its put mapping without giving body it doesn't work.
      const res = await api.put(
