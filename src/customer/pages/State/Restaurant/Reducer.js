  ...
  switch (action.type) {
    ...
    case actionTypes.DELETE_RESTAURANT_SUCCESS:
      return {
        ...
        error: null,
        loading: false,
        //removes specified id from restaurants and usersRestaurant array
    ...
    case actionTypes.CREATE_EVENTS_SUCCESS:
      return {
        ...state,
        loading: false,
        //The events array in the state is updated. A new array is created by spreading the existing 
        //events array (...state.events) and adding action.payload.This adds the newly created event to the existing list of events.
